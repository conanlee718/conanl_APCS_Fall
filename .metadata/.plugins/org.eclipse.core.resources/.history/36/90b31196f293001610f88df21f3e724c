	...
	public String getResponse( String statement ) {
		...
		} else if (statement.findKeyword(statement,"brother") >=0){
			response= "Oh I have a brother too! What is his name?";
		} else if (statement.findKeyword(statement,"Dreyer") >= 0 
				|| statement.findKeyword(statement,"Peel") >= 0
				|| statement.findKeyword(statement,"Michot") >= 0
				|| statement.findKeyword(statement,"Williams") >= 0
				|| statement.findKeyword(statement,"Louie") >= 0
				|| statement.findKeyword(statement,"Dwyer") >= 0 ){
			response= "Wow, you are so lucky you have such a good teacher at Mills!";
		} else if (statement.findKeyword(statement,"Phillips") >= 0){
